...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'translation_translation', (
            ...
            ('origin_content', self.gf('ckeditor.fields.RichTextField')()),
            ('tran_title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255)),
            ('tran_content', self.gf('ckeditor.fields.RichTextField')()),
            ('o_t_content', self.gf('ckeditor.fields.RichTextField')()),
    ...
    models = {
        ...
        u'translation.translation': {
            'Meta': {'ordering': "['-createtime']", 'object_name': 'Translation'},
            ...
            'o_t_content': ('ckeditor.fields.RichTextField', [], {}),
            'origin_content': ('ckeditor.fields.RichTextField', [], {}),
            'position': ('django.db.models.fields.CharField', [], {'max_length': '36'}),
            'show': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'thumbnail': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'tran_content': ('ckeditor.fields.RichTextField', [], {}),
            'tran_title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
