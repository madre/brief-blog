...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Brief.brief'
        db.alter_column(u'albums_brief', 'brief', self.gf('django.db.models.fields.CharField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Brief.brief'
        db.alter_column(u'albums_brief', 'brief', self.gf('django.db.models.fields.CharField')(max_length=500))
